...
#   Utilities > Scripts and Add-Ins > Scripts > + > select this file
#
...
def run(context):
    ...
    try:
        ...
        for occ in root.allOccurrences:
            ...
            # Export each visible occurrence as one visual mesh. If this fails for
            # an occurrence, the row is still written so it can be inspected.
            status = "not_exported"
            try:
